...
class BestDramaView extends StatelessWidget {
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ListView.separated(
                        ...
                        itemCount: state.listBestDrama.isNotEmpty
                            ? state.listBestDrama.length + 1
                            : 21,
                      ),
                    ),
                  ],
  ...
  Widget itemBuilder(BuildContext context, int index) {
    final bloc = BlocProvider.of<BestDramaBloc>(context);
    final item = index < bloc.state.listBestDrama.length
        ? bloc.state.listBestDrama[index]
        : null;
    final itemState = index < bloc.state.listState.length
        ? bloc.state.listState[index]
        : null;
    return TertiaryItem(
          ...
          ? () => (itemState?.watchlist ?? false)
              ? showCupertinoModalPopup(
                  ...
                  builder: (secondContext) => CustomBottomSheet(
                    title:
                        '${item?.name} (${item?.firstAirDate?.substring(0, 4)})',
          ...
          ? () => (itemState?.favorite ?? false)
              ? showCupertinoModalPopup(
                  ...
                  builder: (secondContext) => CustomBottomSheet(
                    ...
                    onPressCancel: () => Navigator.of(secondContext).pop(),
                    onPressConfirm: () =>
                        removeFavorites(context, secondContext, index),
                  ),
                )
  ...
  removeWatchlist(
      BuildContext firstContext, BuildContext secondContext, int index) {
