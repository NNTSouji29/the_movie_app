...
class TrendingView extends StatelessWidget {
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ListView.separated(
                        ...
                        itemCount: state.listTrending.isNotEmpty
                            ? state.listTrending.length + 1
                            : 21,
                      ),
                    ),
                  ],
  ...
  Widget itemBuilder(BuildContext context, int index) {
    final bloc = BlocProvider.of<TrendingBloc>(context);
    final item = index < bloc.state.listTrending.length
        ? bloc.state.listTrending[index]
        : null;
          ...
          ? () => (itemState?.watchlist ?? false)
              ? showCupertinoModalPopup(
                  ...
                  builder: (secondContext) => CustomBottomSheet(
                    title:
                        '${item?.title} (${item?.releaseDate?.substring(0, 4)})',
