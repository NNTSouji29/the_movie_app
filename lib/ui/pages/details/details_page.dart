...
class DetailsPage extends StatelessWidget {
          ...
          builder: (context, state) {
            return Scaffold(
              ...
              appBar: CustomAppBar(
                centerTitle: true,
                title:
                    state.multipleDetails.title ?? state.multipleDetails.name,
                            ...
                            children: [
                                          ...
                                          child: Padding(
                                            ...
                                            child: Hero(
                                              ...
                                              child: CachedNetworkImage(
                                                imageUrl: state.multipleDetails
                                                            .posterPath !=
                                                        null
                              ...
                              SizedBox(
                                ...
                                child: ListView.separated(
                                  physics: const BouncingScrollPhysics(),
                                  padding:
                                      EdgeInsets.fromLTRB(15.w, 2.h, 15.w, 2.h),
                                  ...
                                  itemCount:
                                      state.multipleDetails.genres.length,
                                ),
                              ),
                              SizedBox(height: 10.h),
                                        ...
                                        child: InkWell(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                state.multipleDetails.voteCount
                                                    .toString(),
                                                textScaler:
                                                    const TextScaler.linear(1),
                                                textAlign: TextAlign.center,
                                        ...
                                        child: InkWell(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                state.multipleDetails.popularity
                                                    .toString(),
                                                textAlign: TextAlign.center,
                                                textScaler:
                                                    const TextScaler.linear(1),
  ...
  Widget itemBuilderImage(BuildContext context, int index, int realIndex) {
    ...
    return CachedNetworkImage(
      imageUrl: item?.filePath != null
          ? '${AppConstants.kImagePathBackdrop}${item?.filePath}'
          : '',
      width: double.infinity,
          ...
          children: [
            Expanded(
              ...
              child: Container(
                ...
                child: CachedNetworkImage(
                  imageUrl:
                      '${AppConstants.kImagePathProfile}${item.profilePath}',
                  filterQuality: FilterQuality.high,
                  fit: BoxFit.fill,
                  progressIndicatorBuilder: (context, url, progress) =>
                      const CustomIndicator(),
...
String getDirector(BuildContext context) {
  ...
  if (state.crew.isNotEmpty) {
    final directors = state.crew
        .where((element) =>
            (element.knownForDepartment ?? '').contains('Directing'))
        .toList();
...
String getWriter(BuildContext context) {
  final state = BlocProvider.of<DetailsBloc>(context).state;
  if (state.crew.isNotEmpty) {
    final writers = state.crew.where(
        (element) => (element.knownForDepartment ?? '').contains('Writing'));
    if (writers.isNotEmpty) {
      return writers
              .reduce(
                (value, element) =>
                    (value.popularity ?? 0.0) > (element.popularity ?? 0.0)
                        ? value
                        : element,
              )
              .name ??
